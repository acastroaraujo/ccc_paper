...
My operationalization of "principle based-argumentation" for this particular decision looks at the ${18 \choose 2} = 153$ possible parings and separates them into three separate variables: (1) "Typical" records the number of typical parings---i.e., summing the number of edges on the left-panel ($30$); (2) "Atypical"records the number of atypical parings---i.e., summing the number of edges on the right-panel ($35$); and (3) "Other" records the number of parings that are neither typical or atypical---i.e., $153 - 30 - 35 = 80$.
...
This table allows us to rule out $H_2$. Adding the measurement of "adumbration" never improves the predictive accuracy any the model such that it's more than two standard deviations away from a better fitting model. On the other hand, the measurement for "principle-based argumentation" does significantly improve the predictive accuracy of the models which suggests that there's evidence for $H_1$.
