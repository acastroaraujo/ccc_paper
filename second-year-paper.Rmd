...
-   "Typical"records the number of typical parings---i.e., summing the number of edges on the left-panel ($30$).
...
```{r adum-three-cases, out.width="80%", fig.cap="This graphs looks at the reference contained in three separate cases. From left to right, the measurement for \"adumbration\" is 4, 1, and 0 respectively."}
figure4 + labs(
